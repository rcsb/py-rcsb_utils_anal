...
class EntityInstanceExtractorTests(unittest.TestCase):
    ...
    def testExtractEntryInfo(self):
        ...
        try:
            ...
            ok = self.__mU.doExport(self.__entrySavePath, entryD, fmt="pickle")
            self.assertTrue(ok)
            #
    ...
    def testExtractEntityPolymers(self):
        ...
        try:
            ...
            #
            entryD = self.__mU.doImport(self.__entrySavePath, fmt="pickle")
            #
    ...
    def testExtractEntityInstances(self):
        ...
        try:
            eiExt = EntityInstanceExtractor(self.__cfgOb)
            entryD = self.__mU.doImport(self.__entitySavePath, fmt="pickle")
            ...
            self.assertTrue(len(entryD) > 0)
            ok = self.__mU.doExport(self.__instanceSavePath, entryD, fmt="pickle")
            self.assertTrue(ok)
