...
class ExampleExtractorTests(unittest.TestCase):
    ...
    def __testFindFirst(self, level="95"):
        ...
        #
        self.__extractEntityTaxonomyAndRefDetails([targetTaxId] + hostedTaxIdL)
        ...
        #
        mU.doExport(os.path.join(self.__workPath, "human-containing-entries-by-year.csv"), entriesPerYearCountRowL, fmt="csv")
